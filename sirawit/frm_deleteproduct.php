...
<div class="container" style="margin-top: 30px;">
    <form method="post" action="deleteproduct.php" enctype="multipart/form-data">
        <div class="card shadow-sm border-light rounded" style="background-color: #ffffff; padding: 30px;">
            <h3 class="text-center text-dark mb-4">ลบข้อมูลสินค้า</h3>

            <!-- ฟอร์มแก้ไขข้อมูลสินค้า -->
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="productname" class="form-label">ชื่อสินค้า</label>
                    <input class="form-control" name="productname" type="text" id="productname" value="<?php echo "$row[name]"; ?>" disabled/>
                </div>
                <div class="col-md-6">
                    <label for="productprice" class="form-label">ราคาสินค้า</label>
                    <input class="form-control" name="productprice" type="text" id="productprice" value="<?php echo "$row[price]"; ?>" disabled/>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input class="form-control" name="productdetails" type="text" id="productdetails" value="<?php echo "$row[description]"; ?>" disabled/>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-control" name="category" id="category" disabled>
                        <?php while ($category_row = mysqli_fetch_array($category_result)) { ?>
                            <option value="<?php echo $category_row['category_id']; ?>" <?php echo ($row['category_id'] == $category_row['category_id']) ? 'selected' : ''; ?> disabled>
                ...
                <div class="col-md-6">
                    ...
                    <!-- แสดงภาพเดิม -->
                    <div>
                        <img src="img/<?php echo $row['product_pic']; ?>" alt="Product Image" width="100" height="100" disabled>
                    </div>
                    <input class="form-control mt-2" type="file" name="uploadfile" id="uploadfile" disabled/>
                </div>
            </div>
                ...
                <div class="variant-group mb-3">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="color[]" type="text" value="<?php echo $variant_row['color']; ?>" disabled/>
                        </div>
                        <div class="col-md-3">
                            <label for="size" class="form-label">ไซส์</label>
                            <input class="form-control" name="size[]" type="text" value="<?php echo $variant_row['size']; ?>" disabled/>
                        </div>
                        <div class="col-md-3">
                            <label for="stock_quantity" class="form-label">สต๊อก</label>
                            <input class="form-control" name="stock_quantity[]" type="number" value="<?php echo $variant_row['stock_quantity']; ?>"disabled />
                        </div>
                        <div class="col-md-3">
                            <label for="variant_img" class="form-label">รูปภาพตัวเลือกสินค้า</label>
                            <div>
                                <img src="img/<?php echo $variant_row['variant_pic']; ?>" alt="Variant Image" width="50" height="50" disabled>
                            </div>
                            <input class="form-control mt-2" type="file" name="variant_img[]" disabled/>
                        </div>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-success w-25">ลบสินค้า</button>
